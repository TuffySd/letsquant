...
测试数量：16 个，全部通过。当前工作区在 `milestone/2026-05-27-adjusted-cache` 分支，包含尚未提交的 P0 复权行情生成改动。
...
- 当前未提交文件包括：`.gitignore`、`README.md`、`project_state.md`、`src/letsquant/cli.py`、`src/letsquant/data/adjusted_price.py`、`tests/test_adjusted_price.py`。
